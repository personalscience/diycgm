...
mod_user_view_server <- function(id){
  moduleServer( id, function(input, output, session){
    ...
    output$glucose_plot <- plotly::renderPlotly({
        ...
        message(sprintf("rendering glucose_df...%d rows", nrow(glucose_df())))
